...
export function POSRefund({ onRefundComplete }: POSRefundProps) {
  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-4 py-16 text-center max-w-sm mx-auto">
        ...
        <div>
          <p className="text-xl font-semibold">Refund Processed</p>
        ...
        <p className="text-sm text-muted-foreground">
          Stock has been restored and the audit log has been updated.
        </p>
        ...
        <>
          ...
          <div className="flex items-center justify-between text-sm bg-muted/50 rounded-lg p-3">
            ...
            <div className="text-right">
              ...
              <Badge
                variant={
                  transaction.status === "completed" ? "outline" : "secondary"
                }
                className="text-xs"
              >
                {transaction.status}
              ...
              >
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      updateItem(item.productId, { selected: e.target.checked })
                    }
                  />
                  ...
                  <div className="mt-3 pl-7 grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2 space-y-1">
                      ...
                      <Input
                        ...
                        value={item.reason}
                        onChange={(e) =>
                          updateItem(item.productId, { reason: e.target.value })
                        }
                        className="h-8"
                      />
                    </div>
